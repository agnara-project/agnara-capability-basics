...
`agnara-capability-basics` is **Historical Reference Application #004**, strictly pinned to **`agnara==0.1.0a3`** on **CPython >= 3.14**.

Because of its historical and pedagogical mission:
- **This repository is Frozen.**
- PRs upgrading `agnara` to later versions are rejected.
- PRs introducing web frameworks, database ORMs, or LLM SDKs are rejected.
...
The repository follows a clean, professional GitFlow model:
