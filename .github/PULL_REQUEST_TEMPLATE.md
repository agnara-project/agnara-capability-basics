...
This repository is **Agnara Historical Reference Application #004**, pinned to `agnara==0.1.0a3` on **CPython >= 3.14**.
...
- [ ] I confirm this PR does NOT add web frameworks, database ORMs, HTTP clients, or LLM SDKs.
- [ ] I confirm all handlers remain plain, unwrapped Python callables.

---

## Scope of Changes

- [ ] Core capability logic or domain models
...
- [ ] Documentation and technical contracts match the implemented behavior exactly.